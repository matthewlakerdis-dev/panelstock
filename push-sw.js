...
const ASSETS=['./','./index.html','./panelstock-client.js','./tailwind.css','./icon-192.png','./manifest.json','./icon-mobile-v3-192.png','./icon-mobile-v3-512.png','./icon-adaptive-v4-192.png','./icon-adaptive-v4-512.png'];
