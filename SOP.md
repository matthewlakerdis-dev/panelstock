...
![2. Logging In & Registering](docs/sop/original-4-0.png)
...
![Returning after the app has logged you out](docs/sop/mobile-login.png)

## 3. Viewing Stock & Exporting Reports

Check stock on hand before taking or receiving material.

1. Open <b>SOH</b>. Choose <b>Full panels</b> or <b>Off-cuts</b>.
...
![3. Viewing Stock & Exporting Reports](docs/sop/mobile-stock.png)

## Adding an off-cut

Use this when a job leaves a usable leftover piece worth keeping in stock.

1. Open <b>SOH</b>, choose <b>Off-cuts</b>, then select <b>Add off-cut</b>.
...
![Adding an off-cut](docs/sop/original-7-0.png)
...
![4. Receiving Stock](docs/sop/mobile-receive.png)
...
![Adding missing material while receiving](docs/sop/mobile-missing.png)
...
![5. Dispatching to a Job](docs/sop/original-9-0.png)
...
![6. Writing Off Damaged Stock](docs/sop/original-10-0.png)
...
3. For receipts, damage and other actions, open <b>Settings &gt; Recent activity</b>. The recorded user helps identify who made the entry.

> Job history and activity are records of previous actions. Use current SOH to check what is available now.

![7. Job History](docs/sop/original-11-0.png)
...
![8. Stocktaking Procedure](docs/sop/mobile-backup.png)

## 9. Voiding a Mistaken Entry

Reverse an eligible stock movement without removing the audit history.

1. Open <b>Settings &gt; Recent activity</b>. Find the exact receipt, dispatch or damage entry.
...
![9. Voiding a Mistaken Entry](docs/sop/original-13-0.png)
...
![10. Settings: Materials Catalog](docs/sop/mobile-settings.png)
...
![Adding catalog materials in bulk](docs/sop/mobile-catalog-bulk.png)
...
![11. Settings: Damage Reason Codes](docs/sop/original-16-0.png)

## 12. Settings: Users

Give every staff member their own account.

1. Open <b>Settings &gt; Manage users &amp; admins</b>. Give new staff the current registration code so they can register their own account.
...
![12. Settings: Users](docs/sop/mobile-settings.png)
...
![13. Settings: Email Reports](docs/sop/mobile-settings.png)
...
![14. Settings: Backup & Recovery](docs/sop/mobile-backup.png)
...
![Stocktake reset & Full reset](docs/sop/mobile-backup.png)
...
![Pending changes & sync recovery](docs/sop/mobile-settings.png)
...
![15. CNC Tracker](docs/sop/mobile-cnc.png)

## Scheduling CNC panels

Admins can schedule one panel or enter many panels together.

1. Use <b>Schedule</b> for a single panel, or <b>Schedule multiple panels</b> for several.
...
![Scheduling CNC panels](docs/sop/mobile-cnc-bulk.png)
...
![Confirming a panel or sheet](docs/sop/mobile-sheet-confirm.png)
...
![16. Shared CNC Tracker & Excel](docs/sop/mobile-shared.png)
...
![Excel refresh & status colours](docs/sop/mobile-shared.png)
