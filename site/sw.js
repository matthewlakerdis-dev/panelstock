const CACHE='panelstock-site-v6';
const ASSETS=['/site/','/site/index.html','/site/styles.css?v=factory-match-2','/site/factory-match.css?v=factory-match-5','/site/app.js?v=factory-match-3','/worker/src/brand-logo.js','/site/manifest.webmanifest','/icon-192.png','/icon-512.png'];
