const CACHE='panelstock-site-v9';
const ASSETS=['/site/','/site/index.html','/site/styles.css?v=factory-match-2','/site/factory-match.css?v=factory-match-8','/site/app.js?v=factory-match-3','/worker/src/brand-logo.js','/site/manifest.webmanifest','/icon-192.png','/icon-512.png'];
