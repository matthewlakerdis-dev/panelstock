const CACHE='panelstock-site-v8';
const ASSETS=['/site/','/site/index.html','/site/styles.css?v=factory-match-2','/site/factory-match.css?v=factory-match-7','/site/app.js?v=factory-match-3','/worker/src/brand-logo.js','/site/manifest.webmanifest','/icon-192.png','/icon-512.png'];
