const CACHE='panelstock-site-v3';
const ASSETS=['/site/','/site/index.html','/site/styles.css?v=factory-match-2','/site/app.js','/site/manifest.webmanifest','/icon-192.png','/icon-512.png'];
