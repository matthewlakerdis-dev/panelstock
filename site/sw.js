const CACHE='panelstock-site-v10';
const ASSETS=['/site/','/site/index.html','/site/styles.css?v=factory-match-2','/site/factory-match.css?v=factory-match-9','/site/app.js?v=factory-match-4','/worker/src/brand-logo.js','/site/manifest.webmanifest','/icon-192.png','/icon-512.png'];
