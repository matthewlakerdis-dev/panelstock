const CACHE='panelstock-site-v2';
const ASSETS=['/site/','/site/index.html','/site/styles.css?v=520522f','/site/app.js','/site/manifest.webmanifest','/icon-192.png','/icon-512.png'];
