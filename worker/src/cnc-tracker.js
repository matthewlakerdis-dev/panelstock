...
<main><div id="counts" class="counts"></div><div class="toolbar"><a id="download" class="download">Download Excel</a><button id="expand" type="button">Expand all</button><button id="collapse" type="button">Collapse all</button></div>
<label for="search">Find an order, job, sheet or panel</label><input id="search" type="search" placeholder="Search CNC schedule…">
