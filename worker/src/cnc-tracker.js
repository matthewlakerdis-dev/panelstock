...
<link rel="manifest" href="/cnc-tracker/manifest.webmanifest?token=__CNC_INSTALL_TOKEN__">
...
<meta name="theme-color" content="#f5f5f4"><link rel="apple-touch-icon" href="/cnc-tracker/icon-192.png?v=20260831"><link rel="icon" type="image/png" sizes="192x192" href="/cnc-tracker/icon-192.png?v=20260831">
<style>
...
header{flex-wrap:wrap}header img{width:clamp(400px,120vw,520px);max-width:100%;height:auto;object-fit:contain;flex-shrink:0}.header-right{flex:1;min-width:0}.readonly{max-width:100%}
</style></head><body>
