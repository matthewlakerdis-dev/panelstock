...
export class InventoryStore extends DurableObject {
  constructor(ctx,env) {
    ...
    if(!this.read('qa-settings'))this.write('qa-settings',{enabledFrom:new Date().toISOString(),requireFailurePhoto:true,preventSelfApproval:true});
  ...
  qaSettings(){const saved=this.read('qa-settings',{});return {enabledFrom:saved.enabledFrom||new Date().toISOString(),requireFailurePhoto:saved.requireFailurePhoto!==false,preventSelfApproval:saved.preventSelfApproval!==false};}
