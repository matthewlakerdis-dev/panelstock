...
export function connectCncWorkbook(files, headers, rows, url) {
  ...
  update('xl/workbook.xml','</sheets>',`<sheet name="Daily Report" sheetId="2" r:id="rId5"/><sheet name="Weekly Report" sheetId="3" r:id="rId6"/><sheet name="Monthly Report" sheetId="4" r:id="rId7"/></sheets><definedNames><definedName name="CNC_Tracker" localSheetId="0">'CNC Tracker'!$A$1:$P$${Math.max(1,rowCount+1)}</definedName></definedNames>`);
