...
import {normalizeCncInput,compareCncOrders,cncDuplicateKey} from '../src/cnc-input.js';
...
test('duplicate identity normalizes project, order, sheet and panel references',()=>{
 assert.equal(cncDuplicateKey({jobReference:' pinnacle STUDIOS ',orderNumber:'Order 003',sheetNumber:' 16 ',panelNumber:'a19'}),cncDuplicateKey({jobReference:'Pinnacle Studios',orderNumber:'003',sheetNumber:'16',panelNumber:'A19'}));
 assert.notEqual(cncDuplicateKey({jobReference:'Another Project',orderNumber:'003',sheetNumber:'16',panelNumber:'A19'}),cncDuplicateKey({jobReference:'Pinnacle Studios',orderNumber:'003',sheetNumber:'16',panelNumber:'A19'}));
});
