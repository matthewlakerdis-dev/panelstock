...
test('mobile receive screen can open the missing-material dialog',()=>{
 ...
 assert.match(receiveTab,/onClick: \(\) => setAddingMaterial\(true\)/);
 assert.match(receiveTab,/"Add missing material"/);
});
